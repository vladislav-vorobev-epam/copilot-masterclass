 ...
 * This implementation uses a repository with in-memory persistence.
 */
@Service("enhancedInsuranceService")
@Transactional
public class EnhancedInsuranceServiceImpl implements InsuranceService {
    
    private final InsuranceRepositoryCustom insuranceRepository;
    
    @Autowired
    public EnhancedInsuranceServiceImpl(InsuranceRepositoryCustom insuranceRepository) {
